...
bool GruntBullet::OutOfBounds(SDL_Rect &playerRect)
{
	float distance;
...
bool GruntBullet::CheckBulletPlayerCollision(b2Body* playerBody)
{
...
void GruntBullet::Destroy()
{
	myBody->GetWorld()->DestroyBody(myBody);
}

bool GruntBullet::GetAlive()
{
	return m_alive;
}
void GruntBullet::SetAlive(bool myAlive)
{
	m_alive = myAlive;
}

bool GruntBullet::Collided()
{
	return m_collided;
}
void GruntBullet::SetCollided(bool myCollided)
{
